  ...
  template: `
    <div (click)="navigateToDetail()"
      ...
      <div class="p-6 flex flex-col flex-1">
        ...
        <!-- Footer -->
        <div class="mt-auto pt-5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between group/footer">
          <span class="text-blue-600 dark:text-blue-400 text-sm font-bold">{{ 'COMMON.VIEW_DETAILS' | translate }}</span>
          <div class="w-8 h-8 rounded-full bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 group-hover/footer:bg-blue-600 group-hover/footer:text-white transition-all duration-300">
...
export class PlayCardComponent {
  ...
  getComplexityColor(complexity: string): string {
    switch (complexity) {
      case 'basic': return 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]';
      case 'intermediate': return 'bg-orange-500 shadow-[0_0_8px_rgba(249,115,22,0.5)]';
      case 'pro': return 'bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.5)]';
