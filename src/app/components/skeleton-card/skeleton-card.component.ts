...
@Component({
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden h-full">
      ...
      <div class="p-5 flex flex-col gap-4">
        <!-- Title Placeholder -->
        <div class="h-7 bg-slate-200 rounded-lg w-3/4 animate-pulse"></div>
        ...
        <div class="flex items-center justify-between pt-2 mt-auto">
          <div class="flex items-center gap-2">
            <div class="h-5 w-5 bg-slate-200 rounded-full animate-pulse"></div>
            <div class="h-5 w-16 bg-slate-200 rounded animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
